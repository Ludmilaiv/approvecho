...
if (!isset($category_1->title)) {
  echo json_encode(['err' => ['code' => 15, 'description' => 'Category with id '.$_POST['id_1'].' is not defined']]);
  exit;
}
if (!isset($category_2->title)) {
  echo json_encode(['err' => ['code' => 16, 'description' => 'Category with id '.$_POST['id_2'].' is not defined']]);
  exit;
}
